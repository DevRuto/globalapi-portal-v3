<template>
  <div class="min-w-screen overflow-x-visible">
    <div class="table-fixed text-black dark:text-white mx-auto my-4">
      ...
      <div class="flex flex-col w-full border-2 border-gray-600 rounded-md">
        ...
        <div>
          <div
            ...
            :key="i"
            class="flex flex-col transition ease-in-out duration-75 md:flex-row hover:bg-purple-200 dark:hover:bg-purple-800"
          ...
          >
            ...
            <span class="md:w-1/12 px-2 py-1 text-right text-blue-400"><n-link to="#">Edit</n-link></span>
          </div>
        </div>
      </div>
...
<style scoped>
/*
  default select css from
  https://github.com/tailwindlabs/tailwindcss-forms
  seems to have too much padding
*/
.count {
